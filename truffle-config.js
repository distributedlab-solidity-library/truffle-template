...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      provider: () =>
        new HDWalletProvider([process.env.PRIVATE_KEY], `wss://rinkeby.infura.io/ws/v3/${process.env.INFURA_KEY}`),
    ...
    ropsten: {
      provider: () =>
        new HDWalletProvider([process.env.PRIVATE_KEY], `wss://ropsten.infura.io/ws/v3/${process.env.INFURA_KEY}`),
    ...
    mainnet: {
      provider: () =>
        new HDWalletProvider([process.env.PRIVATE_KEY], `wss://mainnet.infura.io/ws/v3/${process.env.INFURA_KEY}`),
      network_id: 1,
      gas: 8000000,
      gasPrice: 50000000000,
      skipDryRun: true,
    ...
    polygon_mainnet: {
      provider: () =>
        new HDWalletProvider(
          ...
          `wss://late-patient-river.matic.quiknode.pro/${process.env.QUICKNODE_KEY}/`
        ),
      network_id: 137,
      timeoutBlocks: 200,
      skipDryRun: true,
